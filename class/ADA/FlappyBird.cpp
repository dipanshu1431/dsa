...
void endgame() // just some screens for certain actions
{
    ...
    cout << "" << endl
         << endl;
    cout << "                        Y O U R   S C O R E : " << score << endl
         << endl;
...
void credits()
{
    ...
    while (true)
    {
        cout << "" << endl
             << endl;
        cout << "               Lead programmer: Dipanshu143 " << endl
             << endl;
        cout << "               Designer: Dipanshu143 " << endl
             << endl;
        cout << "               Testers: Dipanshu143 " << endl
             << endl;
        cout << "               Special thanks to: Dipanshu143 " << endl
             << endl;
...
void help()
{
    ...
    while (true)
    {
        ...
        cout << "            But be careful, don't hit the pipes or the ground!" << endl
             << endl;
...
void game() // function for playing game
{
    ...
    while (1)        // loop starts, actual gameplay begins
    {
        ...
        if (kbhit())       // if key is pressed, certain operations are done for bird to move up.
        {
            ...
            if (s != '~')
                tuk = 1; // if it is not default, then 'tuk' will be equal to 1, meaning that bird will fly up
        }
        ...
        if (gameover() == true)
            goto gameEnd; // checks if bird hits pipes, if yes, game ends
        ...
        if (tuk > 0)
            tuk++; // if key is pressed, bird will fly up 2 times.
        if (tuk == 3)
            tuk = 0; // after that, bird falls
    }
gameEnd: // ends game
{
    if (score > highscore)
